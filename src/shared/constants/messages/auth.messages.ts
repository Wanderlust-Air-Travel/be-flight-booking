...
export const AUTH_MESSAGES = {
	...
	ERROR: {
		...
		EMAIL_SERVICE_CONNECTION_CLOSED: 'Kết nối dịch vụ email bị đóng. Vui lòng đảm bảo dịch vụ đang chạy',
		EMAIL_SERVICE_TIMEOUT: 'Dịch vụ email không phản hồi. Dịch vụ có thể không khả dụng hoặc quá tải',
	...
	VALIDATION: {
		...
		PASSWORD_TOO_WEAK: 'Mật khẩu quá yếu. Vui lòng sử dụng ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt',

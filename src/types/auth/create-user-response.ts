...
class CreateUserResponseUser {
  @ApiProperty({ example: 'a3f1f8e6-5a6b-4b2d-9f1a-2c3d4e5f6a7b', description: 'User unique identifier' })
  id: string;

  @ApiProperty({ example: 'user@example.com', description: 'User email address', format: 'email' })
  email: string;

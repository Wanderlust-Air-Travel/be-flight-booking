...
export class CreateBookingSegmentServicesTable1735000000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropForeignKey(
            'dbo.BookingSegmentServices',
            'FK_BookingSegmentServices_CabinServices'
        );
        await queryRunner.dropForeignKey(
            'dbo.BookingSegmentServices',
            'FK_BookingSegmentServices_BookingSegments'
        );

        // Drop indexes
        await queryRunner.dropIndex(
            'dbo.BookingSegmentServices',
            'IDX_BookingSegmentService_CabinService'
        );
        await queryRunner.dropIndex(
            'dbo.BookingSegmentServices',
            'IDX_BookingSegmentService_BookingSegment'
        );

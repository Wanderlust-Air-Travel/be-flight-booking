...
export class SaveSeatSelectionDto {
    ...
    @ApiProperty({
        description:
            'Single seat selection (deprecated: use seats array instead for multiple seats)',
    ...
    @ApiProperty({
        description:
            "Array of seat selections for multiple passengers (ADT + CHD, INF don't need seats)",
        type: [SeatSelectionItemDto],
        example: [

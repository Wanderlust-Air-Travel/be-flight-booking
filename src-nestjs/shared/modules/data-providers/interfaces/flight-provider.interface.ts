...
export interface FlightStatusDto {
  ...
  departure: { airport: string; scheduled: string; estimated?: string; actual?: string; delay?: number };
  arrival: { airport: string; scheduled: string; estimated?: string; actual?: string; delay?: number };
  aircraft?: string;
}

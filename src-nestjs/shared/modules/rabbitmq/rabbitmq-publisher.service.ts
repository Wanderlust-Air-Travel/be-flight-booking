...
export class RabbitMQPublisherService {
    ...
    constructor(
        ...
        @Optional() private readonly _redisService?: RedisService,
        @Optional() private readonly _circuitBreakerService?: CircuitBreakerService
    ) {
    ...
    async publishTicketCreation(
        ...
        try {
            ...
            this.logger.error(
                `Error publishing ticket creation message: ${error.message}`,
                error.stack
            );
            throw error;
        }

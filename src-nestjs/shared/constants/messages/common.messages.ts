...
export const COMMON_MESSAGES = {
    ...
    ERROR: {
        ...
        MICROSERVICE_CONNECTION_CLOSED:
            'Kết nối microservice bị đóng. Vui lòng đảm bảo dịch vụ đang chạy.',
        MICROSERVICE_REQUEST_TIMEOUT:
            'Microservice không phản hồi. Dịch vụ có thể không khả dụng hoặc quá tải.',
